...
/**
 * P7.7 — drills into static-membership semantics introduced in P7.4 and
 * relied on by E2E-7-8 (consumer restart with same instance_id triggers
 * no rebalance):
 * <ul>
 ...
 *       in P7.7's first cut — eviction-with-bump is a P7.8 polish if
...
class GroupCoordinatorStaticMembershipTest {
    ...
    void staticRejoinUpdatesSubscriptionWithoutBumpingGeneration() {
        ...
        // Same instance_id but expanded subscription. P7.7 first cut: the
