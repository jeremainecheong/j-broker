...
- [~] **Phase 1** — Raft core: election, log replication, fsync'd persistent state, conflict-index backoff. Unit tests green. Integration tests pass cold; rerun flakiness (port/thread cleanup) pending stabilization before 100-run stress gate can be claimed.
