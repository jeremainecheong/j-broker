...
/**
 * audit-05 — full round-trip for acks=all behaviour under ISR shrink.
 *
 ...
 */
class E2E_Audit05_AcksAllIsrShrinkIT {
    ...
    void acksAllFailsWhileIsrStuckAndRecoversAfterShrink(@TempDir Path d1, @TempDir Path d2, @TempDir Path d3)
        ...
        try (var br1 = Broker.start(new Broker.Config(new NodeId(1), d1, r1, b1, voters).withChaosPort(c1));
