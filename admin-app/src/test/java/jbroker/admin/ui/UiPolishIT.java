 ...
 *       should re-introduce the stale "— Phase 8" label.</li>
...
class UiPolishIT {
    ...
    void topicsPageDoesNotShipTheStalePhase8Footer() {
        ...
        assertThat(html)
                .as("topics.html must pull footer copy from shell.html fragment — no stale '— Phase 8'")
                .doesNotContain("— Phase 8")
    ...
    void overviewPageDoesNotShipTheStalePhase8Footer() {
        ...
        assertThat(html)
                .as("index.html must pull footer copy from shell.html fragment — no stale '— Phase 8'")
                .doesNotContain("— Phase 8")
                .contains("j-broker admin");
    }
    ...
    void raftPageInheritsTheSharedFooterAndHasNoPhase8String() {
        // Spot-check one of the other templates that previously carried the stale "— Phase 8"
