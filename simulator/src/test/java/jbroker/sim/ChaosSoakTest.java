 ...
 * a violation gives a seed that can be replayed under a debugger. Per PRD
 * §Phase-3 DoD: no Raft safety invariant should ever violate across thousands
 * of seeds.
 */
class ChaosSoakTest {

    /**
     * PRD §Phase-3 DoD: 10,000 seeds without a safety violation. Each seed
