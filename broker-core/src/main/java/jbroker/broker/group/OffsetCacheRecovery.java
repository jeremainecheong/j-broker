 ...
 *
 * <p>Compaction is read-time: real on-disk compaction is a Phase 9+ concern.
 ...
 *
 * <p>Group-metadata (Type-2) records are skipped by P7.6 — they're written
 * by P7.8's coordinator failover work and read by a separate recovery walk
