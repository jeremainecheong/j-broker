...
public class AdminEventBus {
    ...
    /**
     * P13.7 — optional side-channel publisher, invoked for every event the
    ...
    /**
     * P13.7 — dedupe set keyed on {@code (brokerEndpoint, brokerEventId)}.
    ...
    private void ingest(String brokerEndpoint, EventMessage msg) {
        // P13.7 — dedupe before allocating a LocalEvent so we don't bump
    ...
    /**
     * P13.7 — inject an event delivered via the external pub/sub channel
    ...
    /**
     * P13.7 — install a fan-out hook. Invoked for every new event the
