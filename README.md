...
- [x] **Phase 15** — Production hardening: broker advertised host/port (external clients reach published Docker ports without `docker exec`), mTLS on the gRPC plane between brokers + admin + clients, Helm chart for Kubernetes.
