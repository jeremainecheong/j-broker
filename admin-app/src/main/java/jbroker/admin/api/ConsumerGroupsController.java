 ...
 * </ul>
 *
 * <p>Reset-offsets + delete-group are deferred out of P8.4. E2E-8-4 covers
 * lag accuracy which is the DoD gate; the two mutations arrive in a later
 * Phase 8/9 slice.
 */
@RestController
...
public class ConsumerGroupsController {
    ...
    /**
     * P12.7 — admin-initiated group removal. Fans across brokers and picks
    ...
    /**
     * P12.7 — admin-initiated offset reset. Body shape:
     * <pre>{@code
     * {
     *   "resets": [
