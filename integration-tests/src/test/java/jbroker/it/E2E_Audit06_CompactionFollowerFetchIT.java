...
/**
 * audit-06 — compaction on the leader while followers (and clients)
 * concurrently fetch from the same partition.
 *
 * <p>{@link E2E_13_1_ForceCompactIT} proves the gRPC fetch path returns
 ...
 * </ol>
 */
class E2E_Audit06_CompactionFollowerFetchIT {
