...
/**
 * chaos control plane UI. Renders a per-broker card grid with
 ...
 *
 * <p>Closes the deferred item: the REST layer + broker-side chaos
 * HTTP servers have been live since , but until now the only way to
