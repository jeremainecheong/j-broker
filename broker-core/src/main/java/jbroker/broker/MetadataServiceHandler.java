...
public final class MetadataServiceHandler {
    ...
    /** P8.6 back-compat constructor — P9.1 adds the partition metrics provider. */
    public MetadataServiceHandler(
            int selfBrokerId,
            BrokerRegistry brokerRegistry,
            BrokerLiveness brokerLiveness,
    ...
    /** P9.1 — full constructor including partition metrics provider. */
    public MetadataServiceHandler(
            int selfBrokerId,
            BrokerRegistry brokerRegistry,
            BrokerLiveness brokerLiveness,
    ...
    public DescribeClusterResponse describeCluster(DescribeClusterRequest req) {
        ...
        for (int bid : known) {
            // P15.1 — DescribeCluster is a client-facing RPC (admin-app
    ...
    public DescribeMetricsResponse describeMetrics(DescribeMetricsRequest req) {
        ...
        // P9.1 — Raft observability (null when no voter; values defaulted to 0).
        if (raftObservability != null) {
        ...
        // P9.1 — per-partition metrics (leader-only).
